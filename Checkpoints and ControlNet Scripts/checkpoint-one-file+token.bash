...
if [ -d "/workspace/stable-diffusion-webui-forge/models/Stable-diffusion" ]; then
...
download_model "CyberRealistic_v5.0" \
...
ls -lhS /workspace/stable-diffusion-webui-forge/models/Stable-diffusion/ | head -10
echo ""
